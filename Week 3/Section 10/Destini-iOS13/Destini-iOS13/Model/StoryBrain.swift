...
// MARK: - Public Methods
extension StoryManager {
    mutating public func nextStory(by choice: String) -> Story {
        let story = stories[currentStoryIndex]
        currentStoryIndex = story.choiceOne == choice ? story.choiceOneDestination : story.choiceTwoDestination
